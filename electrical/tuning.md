...
## 2026年8月4日 —— Python 與數據處理環境準備

### 工作內容
開始搭建後續算法與調試所需的 Python 環境，並處理 Matplotlib 安裝問題。

### 編寫/修改
檢查 Python 環境和 Matplotlib 安裝狀態，確認：
- matplotlib 3.10.6
- numpy 2.3.5
...
### 測試
運行 Matplotlib 相關代碼，確認環境已經能夠正常調用 Matplotlib。

### 階段結果
Python 數據處理環境基本準備完成，為後續可能進行的算法數據可視化、傳感器曲線分析和參數調試做準備。

---

## 2026年8月9日 —— STM32 編譯環境與 Keil 工程排錯
...
## 2026年8月13日 —— Camera Module 3 HDR 架構確認
...
## 2026年8月18日 —— GitHub 工程管理與版本記錄

### 工作內容
開始使用 GitHub 管理項目。

完成/學習：建立 Branch、刪除文件、Commit、`README.md`、`.gitignore`、Collaborators、GitHub Desktop、上傳 `.c/.h`、查看倉庫文件、刪除錯誤文件。

### 項目文件逐漸模組化
倉庫中逐漸形成：LED、MOTOR、USART、`servo.c`、`servo.h`、`README.md`

隨後繼續加入：MPU6050、HC_SR04、Avoidance、TRACK、PID、OLED、CAMERA

### 階段意義
從單純「代碼能運行」開始轉向：可維護、可版本控制、可多人協作的工程項目。

---

## 2026年8月19日 —— 當前階段：系統整合與調參階段
